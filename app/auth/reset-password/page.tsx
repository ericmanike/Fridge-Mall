                ...
                <div className="bg-white rounded-2xl shadow-lg border border-zinc-200 p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button
                            ...
                            className="w-full bg-[#0066FF] text-white py-3 rounded-lg font-semibold hover:bg-[#0066ffbc] transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                        >
                            {loading ? (
                                <>
                        ...
                        <div className="text-center">
                            <Link href="/auth/signIn" className="text-sm text-slate-700 hover:text-slate-900">
                                Back to Login
                            </Link>
                        </div>
                    </form>
