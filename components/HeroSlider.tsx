...
export default function HeroSlider({
  ...
  return (
    <div className="relative w-full h-[250px] sm:h-[350px] lg:h-[450px] overflow-hidden bg-slate-900 select-none mt-10">
      {/* Slides container */}
      <div 
        ...
        {slides.map((slide, index) => {
          return (
            ...
            >
              ...
              {/* Slide Content */}
              <div className="relative h-full max-w-6xl mx-auto px-6 sm:px-12 flex flex-col justify-center items-start z-20">
                <div className="max-w-xl text-left">
                  <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold text-white tracking-tight leading-tight sm:leading-none md:leading-[1.1]">
                    {slide.title}
                  </h1>
                  ...
                  <div className="mt-8">
                    <Link
                      href={slide.ctaLink}
                      className="inline-block bg-white text-slate-950 font-bold px-8 py-3.5 rounded-full hover:bg-slate-100 hover:scale-[1.03] active:scale-[0.98] transition-all duration-200 shadow-md hover:shadow-lg text-sm sm:text-base"
                    >
                      {slide.ctaText}
                    </Link>
                  </div>
